...
```json
{
    "type": "record",
    "name": "logicaltypes",
    "namespace": "ch.suva.furka.kafka.logicaltypes.api",
    "doc": "Furka logicaltypes test Schema",
    "fields": [
        {
            "name": "id",
            "type": {
...
<img width="1184" alt="image" src="https://github.com/user-attachments/assets/8f20e1fd-ff4a-47a7-b950-90b23dd311d7">
